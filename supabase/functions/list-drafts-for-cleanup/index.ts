...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Removido limite superior de 7 dias – queremos listar também drafts antigos

    console.log(`🔍 [LIST-CLEANUP] Buscando documentos criados antes de ${thirtyMinutesAgo} (sem limite superior de idade)`);
